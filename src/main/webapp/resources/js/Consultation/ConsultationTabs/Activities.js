...
function addSelectedAcitivitiesRow(){
    var data = $('#tblActivities').DataTable().row('.selected').data();
    if(checkNotUndefined(data)){
        ...
        table.row.add(data).draw();
        $('#tblActivities').DataTable().row('.selected').remove().draw();
    }else{
...
function editActivity(){
    var activity = $("#editActivityForm input[name=activity]").val();
    var cost = $("#editActivityForm input[name=activityCost]").val();
    var type = $("#editActivityForm [name=idActivityType]").val();
    var include = $("#editActivityForm input[name=consultationDefault]").prop("checked");
    var vaccine  = $("#editActivityForm input[name=idVaccine]").val();
    var data = [];
 
    data.push({name:"idActivity",value:$("#editActivityForm input[name=idActivity]").val()});
    data.push({name:"activity",value:activity});
    data.push({name:"activityCost",value:cost});
    data.push({name:"idActivityType",value:type});
    data.push({name:"consultationDefault",value:include});
    data.push({name:"idVaccine",value:vaccine});
...
function addActivity(){
    ...
    var type = $("#newActivityForm [name=idActivityType]").val();
    var include = $("#newActivityForm input[name=consultationDefault]").prop("checked");
    var vaccine  = $("#newActivityForm input[name=idVaccine]").val();
    var data = [];
