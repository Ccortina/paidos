...
; (function ($) {
    ...
    function drawNavigationControl(plot, canvascontext) {
        ...
        var horizontalZoomin = buttonTemplate.format('zoom-in-horizontal', '0', '0', '<span class="glyphicon glyphicon-resize-horizontal"></span>', ' font-size: larger!important;');
        var zoomin = buttonTemplate.format('zoom-in', '29px', '0', '+', '');
        var verticalZoomin = buttonTemplate.format('zoom-in-vertical', '58px', '0', '<span class="glyphicon glyphicon-resize-vertical"></span>', ' font-size: larger!important;');

        var home = buttonTemplate.format('zoom-home', '29px', '58px', '<span class="glyphicon glyphicon-home"></span>', '');

        var horizontalZoomout = buttonTemplate.format('zoom-out-horizontal', '0', '116px', '<span class="glyphicon glyphicon-resize-horizontal"></span>', ' font-size: larger!important;');
        var zoomout = buttonTemplate.format('zoom-out', '29px', '116px', '-', '');
        var verticalZoomout = buttonTemplate.format('zoom-out-vertical', '58px', '116px', '<span class="glyphicon glyphicon-resize-vertical"></span>', ' font-size: larger!important;');

        var panup = buttonTemplate.format('pan-up', '29px', '29px', '<span class="glyphicon glyphicon-arrow-up"></span>', '');

        var panright = buttonTemplate.format('pan-right', '58px', '58px', '<span class="glyphicon glyphicon-arrow-right"></span>', '');

        var pandown = buttonTemplate.format('pan-down', '29px', '87px', '<span class="glyphicon glyphicon-arrow-down"></span>', '');

        var panleft = buttonTemplate.format('pan-left', '0', '58px', '<span class="glyphicon glyphicon-arrow-left"></span>', '');
        ...
        if(options["navigationControl"]["buttons"] === "basic"){
            zoomin = buttonTemplate.format('zoom-in', '0', '0', '+', '');
            zoomout = buttonTemplate.format('zoom-out', '58px', '0px', '-', '');
            $(control).html(zoomin + whitebox + panup + whitebox + panleft + home + panright + whitebox + pandown + whitebox +  zoomout ).appendTo($placeholder);
        }else{
