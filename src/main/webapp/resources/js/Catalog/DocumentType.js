...
function initializeMainTable(){
    $("#tblMain").DataTable({
        ...
        "ajax":"/demo/catalogs/getAllDocumentCategories",
        "columns":[
            {"data":"category"},
...
function initializeAdditionalInfoTable(){
        ...
        "ajax":{
            "url":"/demo/catalogs/getDocumentTypeRelatedInfo",
            "data":function(){
                return ({id:$("#tblMain").DataTable().row('.selected').data()["idDocumentCategory"]});
            }
        },
        "columns":[
...
function saveNewItem(){
    ...
    $.ajax({
        url:"/demo/catalogs/saveNewDocumentCategory",
        data:data,
...
function saveModifyItem(){
    ...
    $.ajax({
        url:"/demo/catalogs/saveModifyDocumentCategory",
        data:data,
        success:function(response,textStatus,jqXHR){
