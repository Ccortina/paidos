...
function initializeMainTable(){
    $("#tblMain").DataTable({
        ...
        "ajax":"/demo/catalogs/getBirthmethod",
        "columns":[
            {"data":"birthMethod"},
...
function saveNewItem(){
    ...
    $.ajax({
        url:"/demo/catalogs/saveNewBirthmethod",
        data:data,
...
function saveModifyItem(){
    ...
    $.ajax({
        url:"/demo/catalogs/saveModifyBirthmethod",
        data:data,
        success:function(response,textStatus,jqXHR){
