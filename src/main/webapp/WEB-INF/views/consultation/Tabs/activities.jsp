...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <input type="button" class="btn btn-primary" onclick="loadEditActivity();" value="Modificar"/>
        <jsp:include page="addModifyActivities.jsp" />
    </div>
    <div class="col-sm-6">
        <input type="button" class="btn btn-primary" value="Modificar" onclick="loadEditSelectedActivity();"
    </div>
</div>