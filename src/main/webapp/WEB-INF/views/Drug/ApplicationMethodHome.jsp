                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="tab-content">
                                <div id="tabMain" class="tab-pane active">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <input type="button" class="btn btn-primary" value="Nueva presentacion" onclick="newAM()" />
                                        </div>
                                        <div class="col-sm-2">
                                            <input type="button" class="btn btn-primary" value="Modificar presentacion" onclick="modifyAM()" />
                                        </div>
                                        <div class="col-sm-2">
