                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul id="drugAMTabMenu" class="nav nav-tabs">
                              ...
                              <sec:authorize access="hasAnyRole('Doctor','Diagnosticos_Modos de administracion_2')">
                              <li><a href="#tabNew" data-toggle="tab">Nuevo</a></li>
                              </sec:authorize>
                              <sec:authorize access="hasAnyRole('Doctor','Diagnosticos_Modos de administracion_4')">
