<%-- 
    Document   : BirthMethodHome
    Created on : Aug 15, 2014, 6:59:20 PM
...
<c:url var="birthmethodJs" value="/resources/js/Catalog/Birthmethod.js" />
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Tipos de nacimiento</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <ul id="mainTabMenu" class="nav nav-tabs">
                              <li class="active"><a href="#tabMain" data-toggle="tab">Nacimientos</a></li>
                              <sec:authorize access="hasAnyRole('Doctor','Catalogos_Tipos de Nacimiento_2')">
                            ...
                            <div class="tab-content">
                                <div id="tabMain" class="tab-pane active">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="button" class="btn btn-primary" value="Nuevo T. de Nacimiento" onclick="newItem()" />
                                        </div>
                                        </sec:authorize>
                                        <sec:authorize access="hasAnyRole('Doctor','Catalogos_Laboratorio y Gabinete_4')">
                                        <div class="col-sm-3">
                                            <input type="button" class="btn btn-primary" value="Modificar T. de Nacimiento" onclick="modifyItem()" />
                                        </div>
                                        </sec:authorize>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="form-group">
                                                    <label for="inputNewItem">Tipo de nacimiento</label>
                                                    <input type="text" class="form-control inputNormal" id="inputNewItem" placeholder="Tipo de nacimiento" name="itemName"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                ...
                                <div id="tabModify" class="tab-pane">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="form-group">
                                                    <label for="inputModifyItem">Tipo de nacimiento</label>
                                                    <input type="text" class="form-control inputNormal" id="inputModifyItem" placeholder="Tipo de nacimiento" name="itemName"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group">
                                ...
                                <div id="tabAdditionalInfo" class="tab-pane">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3>Pacientes asociados con el tipo de nacimiento</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
