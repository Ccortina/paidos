...
<div class="row">
    ...
    <div class="col-sm-2">
        <div class="row">
            <div class="col-sm-12">
                <input type="button" class="btn btn-primary" value="Modificar" onclick="enableForm('perinatalBackgroundForm');" />
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <input type="button" id="btnperinatalBackgroundFormCancelEditForm" class="btn btn-danger" value="Cancelar" onclick="disableForms();" />
            </div>
        </div>
    </div>
</div>
