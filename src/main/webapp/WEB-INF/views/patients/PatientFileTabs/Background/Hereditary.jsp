...
<div class="row">
    ...
    <div class="col-sm-2">
        <div class="row">
            <div class="col-sm-12">
                <input type="button" class="btn btn-primary" value="Modificar" onclick="enableForm('hereditaryAndFamilyBackgroundForm');">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <input type="button" id="btnhereditaryAndFamilyBackgroundFormCancelEditForm" class="btn btn-danger" value="Cancelar" onclick="disableForms();">
            </div>
        </div>
    </div>
</div>
