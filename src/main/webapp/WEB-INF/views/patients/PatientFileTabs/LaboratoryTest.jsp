...
<div class="row">
    <div class="col-sm-10">
        <table id="tblLaboratoryTestsPatientData">
            <thead>
                <tr>
                    <th>Fecha</th>
                    <th>Estudio</th>
          ...
          <form role="form" id="formLaboratoryTestAdd">
              ...
              <div class="row">
                  <div class="form-group">
                    ...
                    <textarea name="testResult" class="form-control" rows="5" cols="80" ></textarea>
                  </div>
              </div>
          </form>
      </div>
      ...
      <div class="modal-body">
          <form role="form" id="formLaboratoryTestEdit">
              <div class="row">
                  <div class="form-group">
                    <label for="date">Fecha:</label>  
                    <input type="text" name="date" class="datepicker onChange3"/>
                  </div>
              </div>
              <div class="row">
                  <input type="hidden" name="idLaboratoryTestResult" />
                  <input type="hidden" name="idLaboratoryTest" class="onChange3"/>
